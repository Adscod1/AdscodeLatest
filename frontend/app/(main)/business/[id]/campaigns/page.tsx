        ...
        <div className="flex flex-col sm:flex-row gap-4 mb-8 items-start sm:items-center justify-between px-8">
          <div className="relative w-full sm:w-auto">
            ...
            <Input
              ...
              className="pl-10 py-2 w-full sm:w-96"
            />
          </div>
          <div ref={filterRef} className="relative">
            <Button 
              onClick={() => setShowFilters(!showFilters)}
              className="bg-blue-600 rounded hover:bg-blue-700 text-white flex items-center gap-2"
            >
            ...
            {showFilters && (
              <div className="absolute right-0 top-full mt-2 w-80 bg-white rounded-lg shadow-2xl border border-gray-200 p-6 z-50">
                ...
                {/* Suggested Section */}
                <div className="mb-6">
                  <h4 className="text-lg font-bold text-gray-900 mb-3">Suggested</h4>
                ...
                <div>
                  <h4 className="text-lg font-bold text-gray-900 mb-3">Campaign Type</h4>
                  <div className="flex flex-wrap gap-2">
                    <button className="px-4 py-2 rounded-full border-2 border-gray-300 text-gray-700 hover:border-blue-500 hover:bg-blue-50 transition-colors">
                      Open Campaign
                    </button>
                    <button className="px-4 py-2 rounded-full border-2 border-gray-300 text-gray-700 hover:border-blue-500 hover:bg-blue-50 transition-colors">
                      Invite Only
                ...
                <div className="bg-white rounded overflow-hidden shadow hover:shadow-lg transition-shadow cursor-pointer h-full flex flex-col">
                  ...
                  <div className="p-4 flex-1 flex flex-col">
                    ...
                    <div className="flex justify-between items-center text-sm border-t border-gray-200 border-gray-100 pt-3 mt-auto">
                      ...
                      <Button className="bg-blue-600 rounded hover:bg-blue-700 p-3 text-white text-md h-10 w-30 flex items-center gap-2">
                        See details
