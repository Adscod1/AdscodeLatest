...
const WriteReviewPage = () => {
  ...
  const [replies, setReplies] = useState<{[key: string]: Array<{id: string, text: string, user: string, username: string, image: string | null, verified: boolean, date: Date}>}>({});
  ...
  const handleReplySubmit = async (reviewId: string) => {
    ...
    const newReply = {
      ...
      verified: true, // User is logged in, so they're verified
      date: new Date()
    };
        ...
        <div className="grid grid-cols-1 lg:grid-cols-5 gap-4 sm:gap-6 lg:gap-8 px-16  ">
          ...
          <div className="lg:col-span-3 mt-8">
            ...
            <div className="mt-6 sm:mt-8">
              ...
              <h2 className="text-lg sm:text-xl font-semibold text-gray-900 mb-4">Latest Reviews</h2>
                    ...
                    <div key={review.id} className="py-4">
                      <div className="flex items-start gap-3 sm:gap-4">
                        ...
                        <div className="flex-1 min-w-0">
                          ...
                          {/* Action Buttons */}
                          <div className="flex items-center gap-5 mt-4 ml-3 text-xs sm:text-sm">
                            <button 
          ...
          <div className="lg:col-span-2 mt-8">
            <Card className="p-4 sm:p-6 lg:sticky lg:top-6 bg-white">
              ...
              <div className="hover:bg-gray-100 p-1"> 
                ...
                <h3 className="text-base sm:text-lg font-bold text-gray-900">Recommended Reviews</h3>
              </div>
