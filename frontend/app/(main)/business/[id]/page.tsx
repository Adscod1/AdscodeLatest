  ...
  return (
    <div className="min-h-screen bg-gray-50 overflow-x-hidden">
      <div className="mx-auto w-full">
        ...
        <div className="bg-white shadow-sm px-4 sm:px-6 lg:px-12 py-3 sm:py-8 w-full overflow-visible">
          <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4 max-w-full">
            ...
            <div className="flex items-center gap-4 sm:gap-6">
              ...
              <div className="flex-shrink-0 bg-white rounded-xl flex items-center justify-center  border-2 border-white -mt-12 sm:-mt-14 lg:-mt-16 z-10">
                <div className="w-20 h-20 sm:w-24 sm:h-24 lg:w-28 lg:h-28 rounded-xl overflow-hidden bg-gradient-to-br from-blue-400 to-blue-600 shadow-md border-2 border-white">
                  {store.logo ? (
                    <Image
                      src={store.logo}
                      alt={store.name}
            ...
            <div className="flex items-center gap-2 sm:gap-3 flex-wrap w-full sm:w-auto max-w-full">
              <Button className="bg-blue-500 hover:bg-blue-700 text-white px-3 sm:px-4 lg:px-6 py-2 sm:py-2.5 flex items-center gap-2 text-sm sm:text-base">
