...
interface Product {
  ...
  benefitItems?: { id: string; title: string; description?: string | null; productId: string }[];
  ingredientItems?: { id: string; name: string; image?: string | null; description?: string | null; productId: string }[];
  faqItems?: { id: string; question: string; answer: string; productId: string }[];
  store?: {
    id: string;
    name: string;
    tagline?: string | null;
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      <div className="max-w-8xl mx-auto px-4 py-8 sm px-6 lg:px-8">
        ...
        {/* Benefits Section - Only show if there's benefit data */}
        {(product.benefitsIntroText || (product.benefitItems && product.benefitItems.length > 0)) && (
          <div className="bg-white rounded shadow-sm p-6 mb-8">
            <h2 className="text-2xl font-bold text-gray-900 mb-6">Benefits</h2>
            
            <div className="grid lg:grid-cols-2 gap-8 items-center">
              <div className="space-y-6">
                {product.benefitsIntroText && (
                  <div>
                ...
                {product.benefitItems && product.benefitItems.length > 0 && (
                  <div className="space-y-4">
                    {product.benefitItems.map((benefit) => (
                      <div key={benefit.id}>
              ...
              {product.benefitsSectionImage && (
                <div className="aspect-video bg-gray-100 rounded overflow-hidden">
                  <img
                    src={product.benefitsSectionImage}
        ...
        {/* Ingredients Section - Only show if there's ingredient data */}
          ...
          <div className="bg-white rounded shadow-sm p-6 mb-8">
            ...
            <div className="mt-4">
              <div className="grid md:grid-cols-3 gap-6">
                {product.ingredientItems.map((ingredient) => (
                  <div key={ingredient.id} className="bg-gray-50 p-4 rounded">
                    {ingredient.image && (
        ...
        {/* How to Use Section - Only show if there's video or description */}
        {(product.howToUseVideo || product.howToUseDescription) && (
          <div className="bg-white rounded shadow-sm p-6 mb-8">
            <h2 className="text-2xl font-bold text-gray-900 mb-6">How to use</h2>
            
            {product.howToUseDescription && (
              <p className="text-gray-600 leading-relaxed mb-6">{product.howToUseDescription}</p>
            )}
            
            {product.howToUseVideo && (
              <div className="relative aspect-video bg-gray-100 rounded overflow-hidden">
                <video
                  src={product.howToUseVideo}
                  controls
                  className="w-full h-full object-cover"
        ...
        {/* FAQs Section - Only show if there's FAQ data */}
