    ...
    <div className="min-h-screen bg-gray-50 flex flex-col lg:flex-row">
      ...
      <div className={`${selectedConversation ? 'hidden lg:flex' : 'flex'} w-full lg:w-[450px] bg-white border-r border-gray-200 flex-col`}>
        ...
        <div className="p-4 sm:p-6 border-b border-gray-200">
          ...
          <p className="text-xs sm:text-sm text-gray-600">Manage customer communications</p>
        </div>

        {/* Stats */}
        <div className="grid grid-cols-2 gap-2 sm:gap-3 p-3 sm:p-4 border-b border-gray-200">
          {stats.map((stat, idx) => (
            <div key={idx} className="bg-blue-50 rounded p-2 sm:p-3">
        ...
        <div className="p-3 sm:p-4 border-b border-gray-200 space-y-2 sm:space-y-3">
          <div className="relative">
            ...
            <input
              ...
              className="w-full pl-10 pr-4 py-2 border border-gray-200 rounded text-sm focus:outline-none focus:ring-2 focus:ring-blue-500"
            />
          </div>
