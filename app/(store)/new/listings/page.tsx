            ...
            <div className="space-y-6">
              ...
              <div>
                ...
                <div className="space-y-4">
                  {/* Phone Repair Listing */}
                  <div className="bg-white rounded-xl p-6 border border-gray-200">
                    <div className="grid grid-cols-3 gap-4 mb-4">
                      <div>
                        <Input defaultValue="Phone Repair" className="w-full" />
                      </div>
                      <div>
                      ...
                      <div className="flex items-center gap-2">
                        <Input defaultValue="UGX 2000" className="w-full" />
                        <Button
                          variant="ghost"
                          size="icon"
                    ...
                    <Textarea
                      rows={2}
                      defaultValue="Screen replacement, battery replacement, and general repairs."
                      className="w-full"
                    />
                  </div>

                  {/* Computer Setup Listing */}
                  <div className="bg-white rounded-xl p-6 border border-gray-200">
                    <div className="grid grid-cols-3 gap-4 mb-4">
                      <div>
                        <Input
                          defaultValue="Computer Setup"
                          className="w-full"
                        />
                      </div>
                      <div>
                    ...
                    <Textarea
                      rows={2}
                      defaultValue="Software installation and hardware configuration."
                      className="w-full"
                    />
                  </div>
                  ...
                  <div className="bg-white rounded-xl p-6 border border-gray-200">
                    ...
                    <Textarea
                      rows={2}
                      defaultValue="Troubleshooting and technical assistance."
                      className="w-full"
                    />
                  </div>
                </div>
